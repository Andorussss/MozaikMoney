                    ...
                    <div className="padding-vertical padding-xxlarge">
                        <div className="padding-bottom padding-xxlarge">
                            <div className="w-layout-grid footer_top-wrapper">
                                <div className="footer_column">
                                    <a href="/public" aria-current="page" className="footer_logo-link w-nav-brand w--current">
                                        <img
                                            src="/img/temp-logo.png"
                                            loading="lazy" width="163" alt="Logo"/>
                                    </a>
                                    <p className="footer_logo-notes">Lorem ipsum dolor sit amet, consectetur adipiscing
                                        elit.
                                ...
                                <div
                                    ...
                                    <div className="margin-bottom margin-xsmall">
                                        <div  className="text-weight-bold text-color-white">Product
                                        </div>
                                    </div>
                                    <a href="/public" aria-current="page"
                                       className="footer_link w--current">Home</a>
                                ...
                                <div
                                    ...
                                    <div className="margin-bottom margin-xsmall">
                                        <div
                                             className="text-weight-bold text-color-white">Resources
                                        </div>
                                    </div>
                                    <a  href="/blog" className="footer_link">Blogs</a>
                                    <a href="/contact" className="footer_link">Contact</a>
                                    <a  href="/terms-and-condition"
                                       className="footer_link">Terms</a>
                                    <a  href="/privacy-policy" className="footer_link">Privacy
                                        Policy</a>
                                </div>
                            </div>
                        </div>
                        <div className="padding-top padding-medium">
                            <div className="footer_bottom-wrapper">
                                ...
                                <div className="w-layout-grid footer_social-icons">
                                    <a href="https://facebook.com" className="footer_social-link w-inline-block">
